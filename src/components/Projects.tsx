...
const projects: Project[] = [
  ...
  },
  {
    id: 6,
    title: "FinanceApp",
    description: "Uma aplicação web moderna e minimalista para controle de finanças pessoais, permitindo que múltiplos usuários gerenciem suas receitas e despesas de forma independente.",
    category: "JavaScript",
